...
git commit -m ""
~~~
10. внести правки в уже сделанный коммит (параметр no-edit означает, что сообщение остается прежним, если его нужно изменить, то используется флаг -m)
~~~bash
git commit --amend --no-edit
~~~
11. посмотреть историю коммитов
~~~bash
git log
~~~
12. посмотреть историю коммитов в сокращенном виде
~~~bash
git log --oneline
~~~
---
